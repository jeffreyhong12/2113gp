...
void Introduce();
void pokedex();
void level_1_pokemons();        //Three levels of Pokémon illustrations, the body at the bottom
	...
	while (running_flag == 1) {
		...
		switch (Main_menu_input) {
			case int(1) :
				...
				main_battle();
				case int(2) :
					//continue; //Output the contents of all Pokémons information functions
					pokedex();
...
void Introduce() { //Game introduction function
	...
	char back_flag = 'N';
	cout << "Game Play Introduction: This game is a turn-based matchmaking game. There are a total of three Pokemon Gyms (three game levels). Players need to choose two Pokemon as their pets in each Gym, and then use their own two Pokémons to battle with the enemy's Pokemons. Win all three Gyms to achieve victory." << endl;         //Game play introduction
	cout <<" "<<endl;
...
void level_1_pokemons() {   //Level 1 obtainable Pokémon
	system("cls");
	cout << "[System]=> \n";
